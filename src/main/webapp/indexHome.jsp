...
<html lang="es">
    <head>
        ...
        <title>Xesmel (Gestión explotaciones apícolas)</title>
        ...
        <main>
            ...
            <section class="section-padding pb-0" id="about">
                <div class="container mb-5 pb-lg-5">
                    <div class="row">
                        <div class="col-12">
                            <h2 class="mb-3" data-aos="fade-up">¿Cómo surge Xesmel?</h2>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-12 bg-dark">  
                            <div class="d-flex flex-column flex-wrap justify-content-center h-100 py-5 px-4 pt-lg-4 pb-lg-0">
                                ...
                                <p class="text-secondary-white-color" data-aos="fade-up">Podrás llevar un control de gestión y producción.</p>
